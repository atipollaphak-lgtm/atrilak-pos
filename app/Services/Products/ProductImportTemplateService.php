...
class ProductImportTemplateService
{
    public function createTemplate(): Spreadsheet
    {
        ...
        $instructions->fromArray([
            ...
            ['ต้นทุนและราคาขายต้องเป็นตัวเลขที่ไม่ติดลบ ระบบจะปัดเป็นทศนิยม 2 ตำแหน่งแบบ HALF_UP'],
            ['จำนวนเริ่มต้นว่างได้และมีค่าเริ่มต้นเป็น 0 (รองรับทศนิยมไม่เกิน 4 ตำแหน่ง)'],
            ['รหัสสินค้าและบาร์โค้ดว่างได้ ระบบจะสร้างจาก Prefix ของหมวดหมู่ตอนยืนยันนำเข้า'],
