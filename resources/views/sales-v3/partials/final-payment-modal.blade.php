            ...
            <div class="modal-body">
                <div class="final-payment-columns">
                    ...
                    <section id="final-document-panel" class="final-document-panel d-none">
                        <h5>เลือกประเภทเอกสาร</h5><p class="text-muted">เลือกเอกสารที่ต้องการพิมพ์หลังชำระเงิน</p>
                        <label class="d-block p-2"><input id="final-print-delivery" type="checkbox" checked> ใบส่งของ</label><label class="d-block p-2"><input id="final-print-tax" type="checkbox"> ใบกำกับภาษี</label><small id="final-tax-help" class="text-muted d-block">กรุณาเพิ่มข้อมูลผู้เสียภาษีก่อน</small>
