    ...
    <div class="modal-dialog modal-xl modal-dialog-centered">
        <div class="modal-content final-payment-modal-content">
            <div class="modal-header">
                <div class="final-payment-heading"><span class="final-payment-icon"><i class="fas fa-baht-sign"></i></span><div><h4 id="final-payment-title" class="modal-title">ยืนยันการชำระเงิน</h4><p id="final-payment-subtitle">ตรวจสอบรายการสินค้าและยอดรวมก่อนยืนยันการชำระเงิน</p></div></div>
            ...
            <div class="modal-body">
                <div class="final-payment-columns">
                    <section class="final-bill-card">
                        ...
                        <div class="final-items-table-wrap"><table class="final-items-table"><thead><tr><th>#</th><th>สินค้า</th><th>จำนวน</th><th>รวม</th></tr></thead><tbody id="final-preview-items"></tbody></table></div>
                    ...
                    <section id="final-document-panel" class="final-document-panel d-none">
                        ...
                        <div class="final-document-actions"><button id="final-print-delivery" type="button" class="btn btn-outline-primary btn-block" disabled><i class="fas fa-print mr-2"></i>พิมพ์ใบส่งของ</button><button id="final-print-tax" type="button" class="btn btn-outline-primary btn-block" disabled><i class="fas fa-file-invoice mr-2"></i>พิมพ์ใบกำกับภาษี</button></div><small id="final-tax-help" class="text-muted d-none"></small>
                        <button id="final-finish-payment" type="button" class="btn btn-success btn-block btn-lg mt-3" disabled>✓ เสร็จสิ้น</button>
                    </section>
                </div>
            </div>
        </div>
