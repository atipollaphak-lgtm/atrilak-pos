<aside class="pos-v3-cart card">
    ...
    <div class="pos-v3-cart-footer">
        ...
        <button id="v3-submit" type="button" class="btn btn-primary btn-lg btn-block mt-2" aria-busy="false"><i class="fas fa-credit-card mr-1"></i><span>รับชำระเงิน (Enter)</span></button>
    </div>
</aside>
