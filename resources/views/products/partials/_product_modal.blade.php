                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-8">
                            <div class="row">
                                ...
                                <div class="col-md-6 form-group"><label for="productModalCode">รหัสสินค้า</label><input id="productModalCode" name="product_code" value="{{ old('product_code') }}" class="form-control">@error('product_code')<div class="invalid-feedback d-block">{{ $message }}</div>@enderror</div>
                                <div class="col-md-6 form-group"><label for="productModalCategory">หมวดหมู่</label><select id="productModalCategory" name="category_id" class="form-control" required><option value="">เลือกหมวดหมู่</option>@foreach ($categories as $category)<option value="{{ $category->id }}" @selected((string) old('category_id') === (string) $category->id)>{{ $category->name }}</option>@endforeach</select>@error('category_id')<div class="invalid-feedback d-block">{{ $message }}</div>@enderror</div>
                                ...
                                <div class="col-md-6 form-group"><label for="productModalBarcode">Barcode</label><input id="productModalBarcode" name="barcode" value="{{ old('barcode') }}" class="form-control">@error('barcode')<div class="invalid-feedback d-block">{{ $message }}</div>@enderror</div>
