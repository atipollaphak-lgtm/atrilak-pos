(function () {
    ...
    function bind() {
        ...
        $('#final-confirm-payment')?.addEventListener('click', () => { window.jQuery('#payment-confirmation-modal').modal('hide'); context.payment.open(); });
